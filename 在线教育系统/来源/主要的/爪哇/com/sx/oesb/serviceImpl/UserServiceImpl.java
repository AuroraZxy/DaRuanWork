...
public class UserServiceImpl implements UserService {
	...
	public boolean deleteUser(int id) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:57:28
	     * @param u
	     * @return 
	...
	/**
	     ...
	     * @createdate 2022年9月2日 下午3:58:34
	     * @param userId
	     * @param pageSize
	     * @param pageNum
	     * @return 
...
//		去除重复ID
	  ...
	  /**
	     ...
	     * @createdate 2022年9月2日 下午4:09:05
	     * @param userId
	     * @param pageSize
	     * @param pageNum
	     * @return 
...
//		去除重复ID
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午4:43:40
	     * @param userId
	     * @param courseId
	     * @return 
	...
	public boolean isCoursePurchsed(int userId, int courseId) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午4:49:29
	     * @param userId
	     * @param courseId
	     * @return 
	...
	public boolean isCourseStared(int userId, int courseId) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月12日 上午10:29:05
	     * @param userId
	     * @param courseId
	     * @return 
