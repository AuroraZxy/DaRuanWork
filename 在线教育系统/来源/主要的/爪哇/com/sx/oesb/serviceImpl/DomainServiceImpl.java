...
public class DomainServiceImpl implements DomainService{
	 ...
	 * @Title checkAllRootDomains
	   ...
	   * @createdate 2022年9月5日 下午2:39:17
	   * @return 
	...
	public List<Domain> searchChildDomainByID(int id) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午3:22:00
	     * @param domainId
	     * @param name
	     * @param pageSize
	     * @param pageNum
...
//		按时间或价格排序
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午3:54:09
	     * @param d
	     * @return 
	...
	public boolean postDomain(Domain d) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午3:54:47
	     * @param domianId
	     * @param courseId
	     * @return 
	...
	public boolean addCourseDomain(int domianId, int courseId) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午4:01:53
	     * @return 
	...
	public List<Domain> checkAllDomains() {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 
	     * @createdate 2022年9月5日 下午4:02:15
	     * @param id
	     * @return 
	...
	public boolean deleteDomainByID(int id) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午4:23:42
	     * @param courseId
	     * @return 
