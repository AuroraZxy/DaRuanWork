...
public class TeacherServiceImpl implements TeacherService {
	...
	/**
	     ...
	     * @createdate 2022年9月4日 下午3:28:39
	     * @param pageSize
	     * @param pageNum
	     * @return 
	...
	public IPage<Teacher> checkAllTeacher(int pageSize, int pageNum) {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description	调用teachermapper.selectPage
	     * @createdate 2022年9月4日 下午3:28:18
	     * @param name
	     * @param pageSize
	     * @param pageNum
	     * @return 
	...
	public IPage<Teacher> SearchTeacherByName(String name,int pageSize, int pageNum) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:50:29
	     * @param id
	     * @return Teacher
	     **/
	@Override
	 ...
	 * @Title postTeacherInfo
	   * @author 张翔宇
	   * @description
	   * @createdate 2022年9月4日 下午3:14:51
	   * @param teacher
	   * @return 
	 * @see com.sx.oesb.service.TeacherService#postTeacherInfo(com.sx.oesb.entity.Teacher)
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:54:26
	     * @param teacher
	     * @return 
		 * @see com.sx.oesb.service.TeacherService#postTeacherInfo(com.sx.oesb.entity.Teacher)
	     **/
	...
	public boolean postTeacherInfo(Teacher teacher) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月8日 上午9:57:19
	     * @param id
	     * @return 
	...
	public boolean changeTeacherInfo(Teacher teacher) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:28:25
	     * @param id
	     * @param pageSize
	     * @param pageNum
	     * @return 
	...
	public IPage<Course> checkCourseOfTeacher(int id,int pageSize, int pageNum) {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午4:10:47
	     * @param teacherId
	     * @param userId
	     * @return 
	...
	public boolean isTeacherOfUser(int teacherId, int userId) {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description
	     * @createdate 2022年9月4日 下午4:52:17
	     * @param userId
	     * @return 
