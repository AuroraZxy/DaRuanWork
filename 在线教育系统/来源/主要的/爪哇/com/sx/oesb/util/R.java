...
public class R {
    ...
    private Object data;//返回数据
      ...
      /**
         ...
         * @createdate 2022年9月2日 上午10:12:48
         * @return R
         **/
    public R success() {
      ...
      /**
         ...
         * @createdate 2022年9月2日 上午10:12:50
         * @param r
         * @return R
         **/
    public R error(ResponseEnum r) {
      ...
      /**
         ...
         * @createdate 2022年9月2日 上午10:25:19
         * @param code
         * @param message
         * @return R
         **/
    public R error(int code,String message) {
      ...
      /**
         ...
         * @createdate 2022年9月2日 上午10:12:53
         * @param d
         * @return R
         **/
