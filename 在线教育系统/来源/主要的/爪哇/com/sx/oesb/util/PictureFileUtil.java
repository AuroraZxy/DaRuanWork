...
public class PictureFileUtil {	 
	...
	static String docPattern = "\\.(doc|pdf|docx|ppt|pptx|odf)";
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description  上传图片
	     * @createdate 2022年9月7日 上午8:36:14
	     * @param imageFile
	     * @return
	...
	public String uploadImage(MultipartFile imageFile) throws IOException {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 上传文本课件
	     * @createdate 2022年9月12日 下午4:38:51
	     * @param docFile
	     * @return
	     * @throws IOException String
	     **/
	public String uploadDoc(MultipartFile docFile) throws IOException {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月12日 下午4:39:02
	     * @param file
	     * @param pattern
	     * @return
	     * @throws IOException String
...
//	        新名字是uuidName加旧名字的文件后缀
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午10:21:56
	     * @param imgUrl void
	     **/
