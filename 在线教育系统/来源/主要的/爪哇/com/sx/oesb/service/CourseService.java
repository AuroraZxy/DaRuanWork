...
public interface CourseService {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午4:59:12
	     * @param pageSize
	     * @param pageNum
	     * @return IPage<Course>
	     **/
	public IPage<Course> checkAllCourse(int pageSize, int pageNum);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午9:13:53
	     * @param name
	     * @param pageSize
	     * @param pageNum
	     * @param orderTag
	...
	public IPage<Course> searchCourse(String name, int pageSize, int pageNum, int orderTag);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 上午9:34:14
	     * @param courseId
	     * @return Course
	     **/
	public Course searchCourseById(int courseId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 上午8:53:41
	     * @param c
	     * @return boolean
	     **/
	public boolean postCourse (Course c);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午4:11:55
	     * @param course
	     * @param user
	     * @return boolean
	     **/
	public boolean buyCourse(Course course,User user);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 上午9:07:21
	     * @param s
	     * @return boolean
	     **/
	public boolean starCourse(Star s);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午5:03:04
	     * @param courseId
	     * @return List<Chapter>
	     **/
	public List<Chapter> checkAllChaptersOfCourse(int courseId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午2:37:22
	     * @param chapterId
	     * @return List<Section>
	     **/
	public List<Section> checkAllSectionOfChapter(int chapterId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 上午8:58:28
	     * @param c
	     * @return boolean
	     **/
	public int postChapterOfCourse(Chapter c);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午2:38:30
	     * @param s
	     * @return boolean
	     **/
	public int postSectionOfChapter(Section s);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午5:04:03
	     * @param chapterId
	     * @return Chapter
	     **/
	public Chapter searchChapterById(int chapterId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:00:50
	     * @param sectionId
	     * @return Section
	     **/
	public Section searchSectionById(int sectionId);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 删除章节
	     * @createdate 2022年9月4日 下午5:04:41
	     * @param course_id
	     * @param chapter_id
	     * @return boolean
	     **/
	public boolean deleteChapterById(int chapterId);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 删除id小节
	     * @createdate 2022年9月7日 下午2:38:54
	     * @param sectionId
	     * @return boolean
	     **/
	public boolean deleteSectionById(int sectionId);
	  /**
	     ...
	     * @createdate 2022年9月4日 下午5:05:24
	     * @param courseId
	     * @return boolean
	     **/
	public boolean deleteCourseAndChapter(int courseId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 上午9:30:45
	     * @param chapter
	     * @return boolean
	     **/
	public boolean modifyChapter(Chapter chapter);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:03:45
	     * @param section
	     * @return boolean
	     **/
	public boolean modifySection(Section section);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午5:10:46
	     * @param chapterId
	     * @return Course
	     **/
	public Course getCourseOfChapter(int chapterId); 
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:43:38
	     * @param sectionId
	     * @return Chapter
	     **/
	public Chapter getChapterOfSection(int sectionId); 
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午5:12:27
	     * @param courseId
	     * @return int
	     **/
	public int getUserIdOfCourse(int courseId);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 找到课程的老师
	     * @createdate 2022年9月7日 下午2:47:01
	     * @param courseId
	     * @return Teacher
	     **/
	public Teacher getTeacherOfCourse(int courseId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:04:47
	     * @param courseId
	     * @return List<Star>
	     **/
	public List<Star> getStarOfCourse(int courseId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月8日 上午10:21:44
