...
public interface DomainService {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 上传类别
	     * @createdate 2022年9月5日 下午3:51:07
	     * @param d
	     * @return boolean
	     **/
	public boolean postDomain(Domain d);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 为课程添加分类
	     * @createdate 2022年9月5日 下午3:53:07
	     * @param domianId
	     * @param courseId
	     * @return boolean
	     **/
	public boolean addCourseDomain(int domianId,int courseId);
      ...
      /**
         ...
         * @createdate 2022年9月5日 下午3:51:21
         * @return List<Domain>
         **/
    public List<Domain> checkAllDomains();
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午2:30:39
	     * @return List<Domain>
	     **/
	public List<Domain> checkAllParentDomains();
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 按id找类别
	     * @createdate 2022年9月5日 下午2:30:59
	     * @param id
	     * @return Domain
	     **/
	public Domain searchDomainByID(int id);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 按id删除类别
	     * @createdate 2022年9月5日 下午3:50:42
	     * @param id
	     * @return boolean
	     **/
	public boolean deleteDomainByID(int id);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午2:31:17
	     * @param id
	     * @return List<Domain>
	     **/
	public List<Domain> searchChildDomainByID(int id);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月5日 下午3:20:50
	     * @param domainId
	     * @param name
	     * @param pageSize
	     * @param pageNum
	...
	public IPage<Course> searchCourseByDomain(int domainId,String name,int pageSize, int pageNum, int orderTag);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午4:19:46
	     * @param courseId
	     * @return List<Domain>
	     **/
