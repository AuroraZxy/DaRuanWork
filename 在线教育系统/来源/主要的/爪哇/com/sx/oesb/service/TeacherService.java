...
public interface TeacherService {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:00:35
	...
	public IPage<Teacher> checkAllTeacher(int pageSize, int pageNum);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:09:58
	     * @param name
	     * @return IPage<Teacher>
	     **/
	public IPage<Teacher> SearchTeacherByName(String name,int pageSize, int pageNum);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:51:08
	     * @param id
	     * @return Teacher
	     **/
	public Teacher checkTeacherById(int id);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 上传教师信息
	     * @createdate 2022年9月4日 下午3:12:27
	     * @param teacher
	     * @return boolean
	     **/
	public boolean postTeacherInfo (Teacher teacher);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月8日 上午9:56:47
	     * @param id
	     * @return boolean
	     **/
	public boolean deleteTeacher (int id);
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 更改教师信息
	     * @createdate 2022年9月4日 下午3:12:44
	     * @param teacher
	     * @return boolean
	     **/
	public boolean changeTeacherInfo(Teacher teacher);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午3:13:52
	     * @param id
	     * @return IPage<Course>
	     **/
	public IPage<Course> checkCourseOfTeacher(int id,int pageSize, int pageNum);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午4:08:22
	     * @param teacherId
	     * @param userId
	     * @return boolean
	     **/
	public boolean isTeacherOfUser(int teacherId,int userId);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月4日 下午4:51:10
	     * @param userId
	     * @return Teacher
	     **/
