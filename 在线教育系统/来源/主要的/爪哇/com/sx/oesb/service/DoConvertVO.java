...
public interface DoConvertVO {
	  ...
	  /**
	     ...
	     * @createdate 2022年9月11日 下午3:22:36
	     * @param c
	     * @return CommentVO
	     **/
	public CommentVO fillCommentVO(Comment c);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月11日 下午3:22:47
	     * @param a
	     * @return AnswerVO
	     **/
	public AnswerVO fillAnswerVO(Answer a);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月11日 下午3:25:51
	     * @param a
	     * @return ArticleVO
	     **/
	public ArticleVO fillArticleVO(Article a);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月11日 下午3:29:53
	     * @param q
	     * @return QuestionVO
	     **/
	public QuestionVO fillQuestionVO(Question q);
	  ...
	  /**
	     ...
	     * @createdate 2022年9月11日 下午3:09:35
	     * @param uId
	     * @return User
	     **/
