...
public class CourseController {
	...
	/**
	     ...
	     * @createdate 2022年9月7日 上午9:56:31
	     * @return R
	     **/
	...
	public R getParentDomain(){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午9:57:18
	     * @param id
	     * @return R
	     **/
	...
	public R getchildDomain(@PathVariable(required = true,name = "dId") Integer id){
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 查询所有课程
	     * @createdate 2022年9月7日 上午9:57:52
	     * @param pageNum
	     * @param pageSize
	     * @return R
	     **/
	...
	public R getCourseList(@RequestParam(defaultValue = "0")int pageNum,@RequestParam(defaultValue = "8")int pageSize){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午9:58:30
	     * @param name
	     * @param domainId
	     * @param pageNum
	     * @param pageSize
	...
	public R searchCourseList(@RequestParam(required = false) String name,@RequestParam(required = false) Integer domainId,@RequestParam(defaultValue = "0")int pageNum,@RequestParam(defaultValue = "8")int pageSize,@RequestParam(defaultValue = "1") int orderTag){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午9:58:58
	     * @param id
	     * @return R
	     **/
	@ApiOperation("获取课程详情")
	...
	public R getCourse(@PathVariable(required = true,name = "cId") Integer id){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午9:59:19
	     * @param user
	     * @param star
	     * @return R
	     **/
...
//		课程不存在返回错误
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 购买课程
	     * @createdate 2022年9月7日 上午10:00:16
	     * @param user
	     * @param courseId
	     * @return R
	     **/
...
//		余额不够价格，返回错误
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午10:00:33
	     * @param id
	     * @return R
	     **/
	...
	public R getCourseChapterList(@PathVariable(required = true,name = "cId") Integer id){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 上午10:00:48
	     * @param id
	     * @return R
	     **/
	@ApiOperation("查看章节详情")
	...
	public R getCourseChapterDetail(@PathVariable(required = true,name = "cId") Integer id){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:22:47
	     * @param user
	     * @param id
	     * @return R
	     **/
...
//		课程不存在返回错误
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:23:19
	     * @param user
	     * @param id
	     * @return R
	     **/
...
//		课程不存在返回错误
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:27:07
	     * @param id
	     * @return R
	     **/
	...
	public R getChapterSectionList(@PathVariable(required = true,name = "cId") Integer id){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月7日 下午3:27:29
	     * @param id
	     * @return R
	     **/
	@ApiOperation("查看小节详情")
