...
public class TeacherController {
	...
	public TeacherController(TeacherService teacherService) {
	  ...
	  /**
	     ...
	     * @author 张翔宇
	     * @description 全部教师页面
	     * @createdate 2022年9月8日 上午9:24:23
	     * @param pageNum
	     * @param pageSize
	     * @return R
	     **/
	...
	public R getTeacherList(@RequestParam(defaultValue = "0")int pageNum,@RequestParam(defaultValue = "8")int pageSize){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月14日 下午5:04:00
	     * @param name
	     * @param pageNum
	     * @param pageSize
	     * @return R
	...
	public R searchTeacherList(@RequestParam(name = "name")String name,@RequestParam(defaultValue = "0")int pageNum,@RequestParam(defaultValue = "8")int pageSize){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月8日 上午9:24:48
	     * @param id
	     * @return R
	     **/
	@ApiOperation("名师详情")
	...
	public R getTeacher(@PathVariable(required = true)int id){
	  ...
	  /**
	     ...
	     * @createdate 2022年9月8日 上午9:25:06
	     * @param id
	     * @param pageNum
	     * @param pageSize
	     * @return R
